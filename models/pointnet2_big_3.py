...
class get_model(nn.Module):
    def __init__(self, num_parts=2, num_classes=1, normal_channel=False):
        ...
        self.sa1 = PointNetSetAbstractionMsg(npoint=1024, radius_list=[0.01, 0.02, 0.04, 0.08], nsample_list=[64, 128, 256, 512],
                                             in_channel=3+additional_channel,
                                             mlp_list=[[32, 32, 64], [32, 32, 64], [64, 64, 128], [64, 96, 128]])
        self.sa2 = PointNetSetAbstractionMsg(512, radius_list=[0.08, 0.16, 0.32], nsample_list=[64, 128, 256],
                                             in_channel=64+64+128+128,
                                             mlp_list=[[128, 128, 256], [128, 128, 256], [128, 196, 256]])
        self.sa3 = PointNetSetAbstractionMsg(128, radius_list=[0.32, 0.64], nsample_list=[64, 128],
