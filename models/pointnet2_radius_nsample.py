...
class get_model(nn.Module):
    def __init__(self, num_parts=2, num_classes=1, normal_channel=False):
        ...
        self.sa1 = PointNetSetAbstractionMsg(npoint=512, radius_list=[0.01, 0.05, 0.1, 0.2, 0.4],
                                             nsample_list=[16, 32, 64, 128, 256],
                                             in_channel=3+additional_channel,
                                             mlp_list=[[32, 32, 64], [32, 32, 64],
                                                       [32, 32, 64], [64, 64, 128], [64, 96, 256]])
        self.sa2 = PointNetSetAbstractionMsg(128, [0.4, 0.8], [64, 128],
                                             in_channel=64+64+64+128+256,
        ...
        self.fp2 = PointNetFeaturePropagation(in_channel=832, mlp=[256, 128])
