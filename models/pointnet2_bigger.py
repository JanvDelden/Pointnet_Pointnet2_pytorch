...
class get_model(nn.Module):
    def __init__(self, num_parts=2, num_classes=1, normal_channel=False):
        ...
        self.sa1 = PointNetSetAbstractionMsg(npoint=768, radius_list=[0.02, 0.04, 0.08, 0.16], nsample_list=[36, 108, 324, 972],
                                             in_channel=3+additional_channel,
                                             mlp_list=[[32, 32, 64], [64, 64, 128], [64, 96, 128], [64, 96, 128]])
        self.sa2 = PointNetSetAbstractionMsg(384, radius_list=[0.12, 0.24, 0.48], nsample_list=[64, 128, 256],
                                             in_channel=64+128+128+128,
                                             mlp_list=[[128, 128, 256], [128, 196, 256], [128, 196, 256]])
        self.sa3 = PointNetSetAbstractionMsg(192, radius_list=[0.24, 0.48, 0.8], nsample_list=[32, 64, 128],
                                             in_channel=256+256+256,
                                             mlp_list=[[192, 192, 384], [192, 256, 384], [192, 256, 384]])
        self.sa4 = PointNetSetAbstraction(npoint=None, radius=None, nsample=None,
                                          in_channel=384+384+384 + 3,
